  ...
  return (
    <div className="relative w-full min-h-screen bg-[#001708] flex flex-col justify-between overflow-hidden text-white select-none">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-12 my-auto">
        <div className="p-3 rounded-full bg-[#fbfbf8]/95 backdrop-blur-xl border-2 border-secondary-fixed/40 shadow-2xl flex items-center justify-center mb-6 ring-4 ring-black/20">
          <div className="w-32 h-32 flex items-center justify-center overflow-hidden rounded-full">
            <img src={PARAM_LOGO_URL} alt="PARAM Heritage Crest Logo" className="w-full h-full object-contain p-1" />
          </div>
        </div>
