      ...
      <div className="h-16 px-4 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2.5 min-w-0 flex-1">
          {showBack && onBack ? (
            ...
            <div className="w-10 h-10 rounded-full bg-surface-container-lowest overflow-hidden flex items-center justify-center shrink-0 shadow-sm border border-outline-variant/30">
              <img src={PARAM_LOGO_URL} alt="PARAM Logo" className="w-full h-full object-cover" />
            </div>
          )}
